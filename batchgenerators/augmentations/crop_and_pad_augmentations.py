...
def crop(data, seg=None, crop_size = [128, 128, 64], margins=(0, 0, 0), crop_type="center",
    ...
    b = 0 #Batch index to be used to check if the patch has lesion or not
    while (b < data_shape[0]) : 
    # for b in range(data_shape[0]):
        ...
        # ## Pick proper patches
        # seg_cropped_uval = np.unique(seg_cropped)
        # if(b < data_shape[0]//2 and len(seg_cropped_uval) == 1):
